...
// [ZX53] Remove '-' as break character for pocket router
//#define LV_TXT_BREAK_CHARS                  " ,.;:-_"
#define LV_TXT_BREAK_CHARS                  " ,.;:_"
// [ZX53] Remove '-' as break character for pocket router end

// [ZX53] Merge lvgl v7.8.1 partial code, enable if want to use Arabic language parsing
...
#ifndef USE_ANDROID_FBDEV
#  define USE_ANDROID_FBDEV 1
#endif
#ifndef BATTERY_EXTRA_TIME_OUT
#  define BATTERY_EXTRA_TIME_OUT    1
#endif
#ifndef USB_COMPOSITIONS
#  define USB_COMPOSITIONS          1
#endif
#endif /* FEATURE_ROUTER */

#if HIGH_RESOLUTION
#define LV_RES_OFFSET       4
#else
#define LV_RES_OFFSET       1
#endif  /*HIGH_RESOLUTION*/

#define STATUS_BAR_HEIGH    62 * LV_RES_OFFSET
#define MAIN_MENU_ICON_HOR  84 * LV_RES_OFFSET
#define MAIN_MENU_ICON_VER  60 * LV_RES_OFFSET
#define LIST_OBJ_HEIGHT     320 * LV_RES_OFFSET
#define LIST_OBJ_WIDTH      190 * LV_RES_OFFSET
#define LIST_OBJ_PADDING    14 * LV_RES_OFFSET
#define HEADER_ICON_SIZE    32 * LV_RES_OFFSET

#ifdef CUST_LUXSHARE
#  define USE_ANDROID_FBDEV 0
#  define USE_FBDEV         0
#  define BATTERY_EXTRA_TIME_OUT    0
#  define USB_COMPOSITIONS          0
#endif

#define WIFI_SUPPORT
#define SUPPORT_2.4PLUS5GHZ

// Gemteks USB config by BSP is default 9057, so usb debug enable only available for Gemteks
#ifdef CUST_GEMTEKS
#define USB_DEBUG_ENABLING
#endif

#ifdef CUST_ZX73_APAL
#define HIGH_SPEED_SUPPORT
#define HIGH_SPEED_TEMP_MONITOR
//#define HIGH_SPEED_WIFI_DOWN
#endif

#ifdef ZX73_DEFAULT // ZX83 HUB
#define NO_BATTERY
#endif
