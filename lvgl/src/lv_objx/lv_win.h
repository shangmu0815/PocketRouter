...
typedef struct
{
    ...
    lv_obj_t * btnm;                // [ZX53] Create a window objects that include button matrix
...
enum {
    ...
    LV_WIN_STYLE_BTNM_BG,
    LV_WIN_STYLE_BTNM_REL,
    LV_WIN_STYLE_BTNM_PR
 ...
 * @return pointer to the created window
 */
lv_obj_t * lv_win_btn_create_impl(lv_obj_t * par, const char ** btnm_map,
    lv_event_cb_t btnm_action, lv_event_cb_t btnm_action2);
lv_obj_t * lv_win_btn_create(lv_obj_t * par, const char ** btn_map, lv_event_cb_t btnm_action);
// [ZX53] Create a window objects that include button matrix end
