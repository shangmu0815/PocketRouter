...
//set ta pwd show time for pocket router
#define LV_TA_PWD_SHOW_TIME_PR 300    /*ms*/
//set ta pwd show time for pocket router end
/**********************
 *      TYPEDEFS
 **********************/
 ...
 * To add a wide char, e.g. '?' use `lv_txt_encoded_conv_wc('?')`
