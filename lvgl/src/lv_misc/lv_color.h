...
// [ZX53] define pocket router color
//#define LV_COLOR_WHITE   LV_COLOR_MAKE(0xFF,0xFF,0xFF)
//#define LV_COLOR_ORANGE  LV_COLOR_MAKE(0xFF,0xA5,0x00)
//#define LV_COLOR_SILVER  LV_COLOR_MAKE(0xC0,0xC0,0xC0)
#define LV_COLOR_WHITE           LV_COLOR_MAKE(0xF5,0xF5,0xF5)
#define LV_COLOR_REAL_WHITE      LV_COLOR_MAKE(0xFF,0xFF,0xFF)
#define LV_COLOR_WHITE_SMOKE     LV_COLOR_MAKE(0xF8,0xF8,0xF8)
#define LV_COLOR_SILVER          LV_COLOR_MAKE(0xD8,0xD8,0xD8)
#define LV_COLOR_GREYISH_BROWN   LV_COLOR_MAKE(0x4a,0x4a,0x4a)
#define LV_COLOR_MATTERHORN      LV_COLOR_MAKE(0x4c,0x4c,0x4c)
#define LV_COLOR_NIGHT_RIDER     LV_COLOR_MAKE(0x33,0x33,0x33)
#define LV_COLOR_NERO            LV_COLOR_MAKE(0x1F,0x1F,0x1F)
#define LV_COLOR_NOBEL           LV_COLOR_MAKE(0x9B,0x9B,0x9B)
#define LV_COLOR_DARK_GRAY       LV_COLOR_MAKE(0x23, 0x23, 0x23)

//#ifdef BGR_16BIT // Remove R B swap for robopeak display
/* ZX53: LCM setting
 * vi.red.offset   =    0   .length =   5
   vi.green.offset =    5   .length =   6
   vi.blue.offset  =   11   .length =   5
 */
//#define LV_COLOR_ORANGE          LV_COLOR_MAKE(0x23,0xA6,0xF5)
//#else
#define LV_COLOR_ORANGE          LV_COLOR_MAKE(0xF5,0xA6,0x23)
//#endif
// [ZX53] define pocket router color end

#ifdef CUST_DLINK
#define LV_COLOR_BASE            LV_COLOR_MAKE(0x23,0xA6,0xF5)
#elif CUST_ZYXEL
#define LV_COLOR_BASE            LV_COLOR_MAKE(0x00,0xB2,0xFF)
#elif CUST_ONDA
#define LV_COLOR_BASE            LV_COLOR_MAKE(0x40,0xB9,0xFF)
#elif CUST_GEMTEKS
#define LV_COLOR_BASE            LV_COLOR_MAKE(0x23,0x95,0x20)
#else
#define LV_COLOR_BASE            LV_COLOR_ORANGE
#endif

#ifdef CUST_ZYXEL
#define LV_COLOR_SWITCH          LV_COLOR_MAKE(0x64,0xBE,0x00)
#else
#define LV_COLOR_SWITCH          LV_COLOR_BASE
#endif
