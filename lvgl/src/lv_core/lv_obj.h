...
enum {
    ...
    LV_EVENT_DRAG_FAIL,//[ZX53] Called when drag fail on bottom or top
};
...
typedef struct _lv_obj_t
{
    ...
    //[ZX53] fix list touch performance issue
    lv_event_cb_t origin_event_cb;
    //[ZX53] fix list touch performance issue end
...
//[ZX53] fix list touch performance issue
void lv_obj_set_origin_event_cb(lv_obj_t * obj, lv_event_cb_t event_cb);
//[ZX53] fix list touch performance issue end
...
//[ZX53] fix list touch performance issue
lv_event_cb_t lv_obj_get_origin_event_cb(const lv_obj_t * obj);
//[ZX53] fix list touch performance issue end
